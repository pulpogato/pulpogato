...
object Types {
    // Almost Primitives
    val BOOLEAN: ClassName = ClassName.get(Boolean::class.java)
    val INTEGER: ClassName = ClassName.get(Integer::class.java)
    val LONG: ClassName = ClassName.get(Long::class.java)
    val FLOAT: ClassName = ClassName.get(Float::class.java)
    val DOUBLE: ClassName = ClassName.get(Double::class.java)
