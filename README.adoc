...
For releases, you can use https://central.sonatype.com/[Maven Central].
...
Or you can use https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-gradle-registry#using-a-published-package[GitHub Packages].
This would be the URL for that.
