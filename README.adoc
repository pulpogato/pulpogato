...
:snapshot-middle: %2Fmaven-metadata.xml&style=for-the-badge&label=Snapshot&color=green[alt=Maven Snapshot,height=20,link="https://central.sonatype.com/service/rest/repository/browse/maven-snapshots/io/github/pulpogato/
:snapshot-suffix: /"]
