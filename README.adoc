...
ext {
    ...
    set("ghVersion", "fpt")
    set("pulpogatoVersion", "0.26.0")
}

dependencies {
    implementation("io.github.pulpogato:pulpogato-rest-${property("ghVersion")}:${property("pulpogatoVersion")}")
    implementation("io.github.pulpogato:pulpogato-graphql-${property("ghVersion")}:${property("pulpogatoVersion")}")
}
...
This lists the `1.x` versions that work with Jackson 3.x.
For Jackson 2.x, look at the `0.x` versions on the https://github.com/pulpogato/pulpogato/tree/release/0.x[release/0.x] branch.
