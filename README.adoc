...
Look at https://github.com/pulpogato/pulpogato-demo[the demo project] for a working example.
...
|https://docs.github.com/en/enterprise-server@3.22[GHES-3.22]
|{central-prefix}pulpogato-graphql-ghes-3.22{central-middle}pulpogato-graphql-ghes-3.22{central-suffix} {snapshot-prefix}pulpogato-graphql-ghes-3.22{snapshot-middle}pulpogato-graphql-ghes-3.22{snapshot-suffix}
|{central-prefix}pulpogato-rest-ghes-3.22{central-middle}pulpogato-rest-ghes-3.22{central-suffix} {snapshot-prefix}pulpogato-rest-ghes-3.22{snapshot-middle}pulpogato-rest-ghes-3.22{snapshot-suffix}
...
|{central-prefix}pulpogato-graphql-ghes-3.17{deprecated-middle}pulpogato-graphql-ghes-3.17{central-suffix}
|{central-prefix}pulpogato-rest-ghes-3.17{deprecated-middle}pulpogato-rest-ghes-3.17{central-suffix}
