...
public class GeneratedTestFailureWatcher implements TestWatcher {
    ...
    public void testFailed(ExtensionContext context, Throwable cause) {
        ...
        if (testMethod.isPresent()) {
            Generated generated = findGeneratedAnnotation(
                    testMethod.get(), context.getTestClass().orElse(null));
            if (generated != null) {
                ...
                System.out.println(
                        "Generated test failed: " + displayName + " (Schema: " + generated.schemaRef() + ")");
            }
        }
    }
