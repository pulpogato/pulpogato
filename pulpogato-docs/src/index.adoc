...
* GitHub Discussion forms (`.github/DISCUSSION_TEMPLATE/*.yml`) as `GithubDiscussion`
* GitHub Issue Template Chooser config (`.github/ISSUE_TEMPLATE/config.yml`) as `GithubIssueConfig`
