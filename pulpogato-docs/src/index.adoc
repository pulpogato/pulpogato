...
[source,java,indent=0]
----
include::../../pulpogato-common/src/test/java/io/github/pulpogato/common/cache/DocumentationIntegrationTest.java[tags=setup-cache]
----
...
[source,java,indent=0]
----
include::../../pulpogato-common/src/test/java/io/github/pulpogato/common/cache/DocumentationIntegrationTest.java[tags=advanced-cache]
----
